/**
 * 本文件的规则由 eslint-plugin-import 插件提供
 * import/xx 的即为 import 插件规则，文档见：https://github.com/benmosher/eslint-plugin-import
 */
...
module.exports = {
  ...
  rules: {
    ...
    // @off 使用 webpack 的 externals、alias 时需要安装额外的插件
    ...
    // @off eslint 原生已支持，会报 Parsing error: `foo` has already been exported.
    'import/export': 'off',
