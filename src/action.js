...
export function changeNum(text){
    return (dispatch,getState)=>{
        const { sign,value,inputStatePre,statePreNum,calculSateNum, calculStateOpetation} = getState()
            let result = 0;
            let sign1='';
            let preNum=0;
            let preInput =''
            ...
            let calculOptation=''//用来标记最后一个计算符
                           ...
                           switch(text){
                               case '=':{ 
                                ...
                                preNum=statePreNum;
                                   ...
                                   preNum= eval(statePreNum+calculStateOpetation+(calculSateNum));
                            }break;
